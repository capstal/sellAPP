<template>
  <div class="food" v-show='showFlag' transition='fadeIn' v-el:food>
    <div class="food-content">
      ...
      <div class="content">
        ...
        <div @click.stop.prevent='addFirst' class="buy" v-show='!food.count || food.count===0' transition='out'>加入购物车
        </div>
      </div>
